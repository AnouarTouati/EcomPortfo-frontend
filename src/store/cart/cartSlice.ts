...
const cartSlice = createSlice({
    ...
    extraReducers(builder) {
        builder.addCase(getItemsCountAsync.fulfilled,(state,action:PayloadAction<number>)=>{
            state.itemsCount = action.payload
        })
    },
})
export const getItemsCountAsync = createAsyncThunk("cart/getItemsCountAsync",async ()=>{
